				...
				if($error == 0){
					...
					if($res->num_rows > 0){
						if($result['confirmed'] == 1){
							...
							echo "<a href='register.php' style='text-align: center;display:block;font-size: 162.5%;'>Return back to Register Page</a>";
							exit();
						}
					}
						...
						<div class="panel-body">
							<form action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
								<div class="form-group">
									...
									<input type="text" name="fname" class="form-control" value="<?php echo (isset($_SESSION['fname']) ? $_SESSION['fname'] : ''); ?>" placeholder="Enter your First Name" required="">
								</div>

								<div class="form-group">
									<label for ="lname" style="font-weight: bolder" >Last Name :</label>
									<input type="text" name="lname" class="form-control" value="<?php echo (isset($_SESSION['lname']) ? $_SESSION['lname'] : ''); ?>" placeholder="Enter your Last Name" required="">
								</div>
							...
							<!-- checkboxes end here ;) -->
								...
								<div class="form-group">
									...
									<input type="email" name="email" class="form-control" value="<?php echo (isset($_SESSION['email']) ? $_SESSION['email'] : ''); ?> " placeholder="Enter your Email ID" required="">
									<span class="error"><?php echo $emailRegistered;?></span>
								</div>

								<div class="form-group">
									<label for ="pwd" style="font-weight: bolder" >Password :</label>
									<input type="password" name="pwd" class="form-control" minlength="6" value="<?php echo (isset($_SESSION['pwd']) ? $_SESSION['pwd'] : ''); ?> " placeholder="Enter Password" required="">
								</div>

								<div class="form-group">
									<label for ="cpwd" style="font-weight: bolder" >Confirm Password :</label>
									<input type="password" name="cpwd" class="form-control" value="<?php echo (isset($_SESSION['cpwd']) ? $_SESSION['cpwd'] : ''); ?> " placeholder="Confirm Password" required="">
									<span class="error"><?php echo $passwordMismatchError;?></span>
								</div>

								<div class="form-group">
									<label for ="mobile" style="font-weight: bolder" >Mobile No. :</label>
									<input type="text" name="mobile" maxlength="10" pattern="[6789][0-9]{9}" class="form-control" value="<?php echo (isset($_SESSION['mobile']) ? $_SESSION['mobile'] : ''); ?>" placeholder="Enter your Mobile No." required="">
									<span class="error"><?php echo $mobileLenError;?></span>
								</div>

								<div class="form-group">
									<label for ="city" style="font-weight: bolder" >City :</label>
									<input type="text" name="city" class="form-control" value="<?php echo (isset($_SESSION['city']) ? $_SESSION['city'] : ''); ?> " placeholder="Enter your current City" required="">
								</div>
								...
								<div>
									...
									<div class="form-group">
										...
										<input type="time" name="starttimeWeeks" step="1" value="<?php echo (isset($_SESSION['starttimeWeeks']) ? $_SESSION['starttimeWeeks'] : '');?>" class="form-control" required="">
									</div>

									<div class="form-group">
										<label for ="endtime">End Time :</label><br>
										<input type="time" name="endtimeWeeks" step="1" value="<?php echo (isset($_SESSION['endtimeWeeks']) ? $_SESSION['endtimeWeeks'] : '');?>" class="form-control" required="">
									</div>
								...
								<div>
									...
									<div class="form-group">
										<label for ="starttime">Start Time :</label><br>
										<input type="time" name="starttimeWeekend" step="1" value="<?php echo (isset($_SESSION['starttimeWeekend']) ? $_SESSION['starttimeWeekend'] : '');?>" class="form-control" required="">
									</div>

									<div class="form-group">
										<label for ="endtime">End Time :</label><br>
										<input type="time" name="endtimeWeekend" step="1" value="<?php echo (isset($_SESSION['endtimeWeekend']) ? $_SESSION['endtimeWeekend'] : '');?>" class="form-control" required="">
									</div>
								...
								<h5 style="text-align: center;"><a href="login.php" style="color: #50505e; text-decoration: none;">Already a member?</a></h5>
