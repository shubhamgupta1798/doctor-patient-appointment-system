            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <h1 style="text-align: center;">Accepted donors</h1><br>
                        <form method="POST">
                          <?php
                              include 'database_connection.php';
                              $user_name = $_SESSION['user'];
                              $sql = "SELECT * from blood_request where doctor_username = '$user_name'";
                              ...
                              if ($result->num_rows == 0) {
                                ...
                                echo "<tr>";
                                echo "<th>Patient Username</th><th>Patient Blood-Group</th>";
                                echo "</tr>";
