            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <h1 style="text-align: center;">Cancelled Appointments</h1><br>
                        <form method="POST">
                          <?php
                              include 'database_connection.php';
                              $user_name = $_SESSION['user'];
                              $sql = "SELECT * from patient_doctor where doctor_username = '$user_name' and valid = -2"; //it has been approved by the doctor in the past. Now the action needs to be taken
                              ...
                              if ($result->num_rows == 0) {
                                ...
                                echo "<tr>";
                                echo "<th>Patient Username</th><th>Patient Email-ID</th><th>Date of Appointment</th><th>Time of Appointment</th>";
                                echo "</tr>";
